...
class McsHelper extends \Magento\Framework\App\Helper\AbstractHelper
{
	...
	public function getLicenceKey(){
		return $this->scopeConfigObject->getValue("mconnect_priceslider/active/licence_key", \Magento\Store\Model\ScopeInterface::SCOPE_STORE, $this->getStore());
	}	
	public function getSerialKey(){
		return $this->scopeConfigObject->getValue("mconnect_priceslider/active/serial_key", \Magento\Store\Model\ScopeInterface::SCOPE_STORE, $this->getStore());
	}
