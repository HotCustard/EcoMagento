...
namespace Webkul\Quotesystem\Block\Adminhtml\Managequotes\Edit\Tab;

use Magento\Backend\Block\Widget\Grid;
use Magento\Backend\Block\Widget\Grid\Extended;
use Webkul\Quotesystem\Model\ResourceModel\Quoteconversation\Collection;
use Webkul\Quotesystem\Helper\Data;
use \Webkul\Quotesystem\Model\QuoteconversationFactory;
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn(
            ...
            [
                ...
                'index'     => 'sender',
                'filter'    =>  false,
                'renderer'  => \Webkul\Quotesystem\Block\Adminhtml\Managequotes\Grid\RendererSenderName ::class,
            ]
        );
        $this->addColumn(
            'receiver',
            [
                ...
                'index'     => 'receiver',
                'filter'    =>  false,
                'renderer'  => \Webkul\Quotesystem\Block\Adminhtml\Managequotes\Grid\RendererReceiverName ::class,
            ]
        );
        $this->addColumn(
            'conversation',
        ...
        $this->addColumn(
            ...
            [
                ...
                'sortable'  => true,
                'index'     => 'attachments',
                'renderer'  => \Webkul\Quotesystem\Block\Adminhtml\Managequotes\Grid\RendererAttachments ::class,
            ]
        );
        $this->addColumn(
            'created_at',
            [
                ...
                'index'     => 'created_at',
                'type'      => 'datetime',
                'renderer'  => \Webkul\Quotesystem\Block\Adminhtml\Managequotes\Grid\RendererReceiverTime ::class,
            ]
        );
