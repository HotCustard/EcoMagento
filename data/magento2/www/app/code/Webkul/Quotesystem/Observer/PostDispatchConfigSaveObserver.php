    ...
    public function execute(\Magento\Framework\Event\Observer $observer)
    {
        try {
            ...
            if ($params['section'] == 'quotesystem' && isset(
                $params['groups']['wk_quotesystemsetting']['fields']['wk_quotesystemenabledisable']
            )) {
                $moduleStatus = $params['groups']['wk_quotesystemsetting']
                                            ['fields']['wk_quotesystemenabledisable']['value'];
                if ($moduleStatus) {
