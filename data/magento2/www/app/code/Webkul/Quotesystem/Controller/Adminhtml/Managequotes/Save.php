...
class Save extends \Magento\Backend\App\Action
{
    ...
    public function updateQuoteData($data, $quote)
    {
        ...
        $approvedStatus = \Webkul\Quotesystem\Model\Quotes::STATUS_APPROVED;
        $soldStatus = \Webkul\Quotesystem\Model\Quotes::STATUS_SOLD;
    ...
    {
        if ($data["status"] == \Webkul\Quotesystem\Model\Quotes::STATUS_SOLD
            || $quote->getStatus()== \Webkul\Quotesystem\Model\Quotes::STATUS_SOLD
        ) {
            $this->messageManager->addError(
                __(
        ...
        if ($data['status'] == \Webkul\Quotesystem\Model\Quotes::STATUS_APPROVED &&
